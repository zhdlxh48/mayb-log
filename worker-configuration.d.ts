/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: db57db4093fa0e35d15b1e4304679f83)
// Runtime types generated with workerd@1.20260908.1 2026-09-09 nodejs_compat
interface __BaseEnv_Env {
	MEDIA: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	SITE_URL: "https://mayb-log.mayb.workers.dev";
	TURNSTILE_SITE_KEY: "0x4AAAAAAExikRB68jL2j075";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_URL" | "TURNSTILE_SITE_KEY" | "BETTER_AUTH_SECRET" | "TURNSTILE_SECRET_KEY">> {}
}

...
mediaRoutes.get("/media/posts/:postUuid/:imageUuid.webp", async (req, res) => {
  if (!validUuid(req.params.postUuid) || !validUuid(req.params.imageUuid))
    return res.sendStatus(404);
  const object = await req.app.locals
    .bindings()
    .MEDIA.get(imageKey(req.params.postUuid, req.params.imageUuid));

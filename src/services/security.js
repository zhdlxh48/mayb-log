...
export const FAKE_PASSWORD_RECORD = {
  password_hash: "TNN9chWpHz4ee/oos5j8JECqRiggDk2XhwAmZqRS/dU=",
  password_salt: "bWF5Yi1sb2ctZmFrZS1zYWx0",
...
export async function verifyPassword(password, user) {
  const candidate = bytes(
    (await passwordHash(password, bytes(user.password_salt), user.password_iterations)).hash,
  );
...
export const sessionCookie = (token, maxAge = SESSION_SECONDS) =>

...
VALUES
  (
    'testuser',
    'MayB',
    'Fh6+RrU89zPKNMiJeZH6khZAhE4N+b26TrQtoB654fQ=',
    'BL1B3TnH/OxMLpVlacU/TQ==',
    100000,
    'active',
    1788793200,
    1788793200
...
VALUES
  ('Blog Notes', '블로그 개발 기록', 1788793200, 1788793200);
...
VALUES
  (
    ...
    '한국 시간 기준의 **기록**입니다.',
    '<p>한국 시간 기준의 <strong>기록</strong>입니다.</p>',
    NULL,
    NULL,
    '["기록"]',
    1766223000,
...
VALUES
  (
    ...
    '삭제해도 되는 샘플 글',
    'Cloudflare Workers, D1, R2를 이용한 새 블로그 구조를 소개합니다.',
    '이 글은 삭제해도 되는 샘플입니다. 간단한 구조 Express route가 D1 SQL을 실행하고 EJS가 HTML을 만듭니다.'
  ),
